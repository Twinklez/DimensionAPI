...
public class DedicatedServer extends MinecraftServer implements IServer
{
	...
	protected void loadAllDimensions(String par1Str, String par2Str, long par3, WorldType par5WorldType)
    {
		...
		/**DIMENSION API EDIT**/
        theWorldServer = new WorldServer[DimensionAPI.numberOfDimensions];
        /**END EDIT**/
        ...
        {
            /**DIMENSION API EDIT**/int/**END EDIT**/ byte0 = 0;
            if (i == 1)
            {
                byte0 = -1;
            }
			...
			/**DIMENSION API EDIT**/
			if (DimensionAPI.numberMap.containsValue(Integer.valueOf(i)))
            {
                byte0 = ((Integer)DimensionAPI.getKeyFromValue(DimensionAPI.numberMap, new Integer(i))).intValue();
            }
			/**END EDIT**/
            ...
            getConfigurationManager().func_72364_a(theWorldServer);
        }
