...
public class IntegratedServer extends MinecraftServer
{
    ...
    public IntegratedServer(Minecraft par1Minecraft, String par2Str, String par3Str, WorldSettings par4WorldSettings)
    {
		...
		/**DIMENSION API EDIT**/
		DAPICompatibility.minecraftServer_registerCommandsToModLoader(this);
		/**END EDIT**/
    ...
    protected void loadAllDimensions(String par1Str, String par2Str, long par3, WorldType par5WorldType)
    {
		...
		/**DIMENSION API EDIT**/
        this.theWorldServer = new WorldServer[DimensionAPI.numberOfDimensions];
		/**END EDIT*/
        ...
        {
            /**DIMENSION API EDIT**/int/**END EDIT**/ var8 = 0;
			...
			/**DIMENSION API EDIT**/
			if (DimensionAPI.numberMap.containsValue(Integer.valueOf(var7)))
            {
                var8 = ((Integer)DimensionAPI.getKeyFromValue(DimensionAPI.numberMap, new Integer(var7))).intValue();
            }
			/**END EDIT**/
