...
public abstract class WorldProvider
{
    ...
    {
		/**DIMENSION API EDIT**/
		if(DAPICompatibility.modLoaderInstalled())
		{
			worldChunkMgr = DAPICompatibility.worldType_getChunkManager(terrainType, worldObj);
			return;
		}
		/**END EDIT**/
    ...
    public IChunkProvider getChunkProvider()
    {
		...
		if(DAPICompatibility.modLoaderInstalled())
		{
			return DAPICompatibility.worldType_getChunkGenerator(terrainType, worldObj);
		}
		/**END EDIT**/
    ...
    public int getAverageGroundLevel()
    {
		...
		if(DAPICompatibility.modLoaderInstalled())
		{
			return DAPICompatibility.worldType_getSeaLevel(terrainType, worldObj);
		}
		/**END EDIT**/
    ...
    public boolean getWorldHasVoidParticles()
    {
		...
		if(DAPICompatibility.modLoaderInstalled())
		{
			return DAPICompatibility.worldType_hasVoidParticles(terrainType, hasNoSky);
		}
		/**END EDIT**/
    ...
    public double getVoidFogYFactor()
    {
		...
		if(DAPICompatibility.modLoaderInstalled())
		{
			return DAPICompatibility.worldType_voidFadeMagnitude(terrainType);
		}
		/**END EDIT**/
